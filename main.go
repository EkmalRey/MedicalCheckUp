...
func patient_see(flag string) {
	...
	fmt.Print("   ")
	underline("Menu Navigation :")
	fmt.Println("   1. Sort By ID")
	fmt.Println("   2. Sort By Package")
	fmt.Println("   3. Sort By Latest Medical Checkup")
	fmt.Println("   0. Return")
...
func patient_delete(idx int) {
	...
	for !validAccept {
		...
		if accept == "yes" {
			...
			fmt.Println(" Invalid Choice! Are you sure to delete this patient? (yes or no) : ")
		}
	}
}
...
func record_delete(idx int) {
	...
	for !validAccept {
		...
		if accept == "yes" {
			...
			fmt.Println(" Invalid Choice! Are you sure to delete this record? (yes or no) : ")
		}
	}
}
